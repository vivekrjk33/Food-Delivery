...
struct NetworkingServices {
    ...
    func fetchCategoriesDishes(categoryId : String, completion : @escaping (Result<[Dish] ,Error>) -> Void) {
    ...
    /// MARK :- Create the generic function to API
    ...
    /// parameters : whatever extra information you need topass to the backend
    /// Returns : URLRequest
